...
const { version: waVersion, isLatest } =
  await fetchLatestBaileysVersion().catch((err) => {
...
if (waVersion) {
  ...
  console.log(
    chalk.cyan(
      `Using WhatsApp Web version: v${verStr} (${
...
async function _quickTest() {
  ...
  if (s.ffmpeg && !s.ffmpegWebp) {
    conn.logger.warn(
      "Sticker Mungkin Tidak Beranimasi tanpa libwebp di ffmpeg (--enable-libwebp while compiling ffmpeg)"
    );
  }
